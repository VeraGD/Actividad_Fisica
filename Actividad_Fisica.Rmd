...
### 1.1. Conclusión:
*(intentaría cambiar los nombres de los niveles, ya que `d1_2` es poco entendible. A lo mejor lo que tenéis acá es simplemente un gradiente de ejercicio, desde `Nada` hasta `Mucho` y en métodos explicáis qué significa cada uno (`d1_2` es poco ejercicio)).
...
### 2.1. Conclusión:
*(Re-interpretar las conclusiones ya que el modelo elegido probablemente no estaba contando "todo el cuento")
